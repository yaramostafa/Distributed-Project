...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.car_x_coordinate = (self.display_width * 0.6)
        ...
        # Background
        self.bgImg = pygame.image.load(".\\img\\back_ground1.png")
    ...
    def run_car(self):
        while not self.crashed:
            ...
            self.enemy_car2_starty += self.enemy_car_speed
            ...
            if self.car_y_coordinate < self.enemy_car_starty + self.enemy_car_height or self.car_y_coordinate < self.enemy_car2_starty + self.enemy_car2_height:
            ...
            if self.car_x_coordinate < 50 or self.car_x_coordinate > 950:
                 self.crashed = True
                 self.display_message("Game Over !!!")
    ...
    def highscore(self, count):
        ...
        self.gameDisplay.blit(text, (0, 0)) #65
