...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('.\\img\\car5.png')
        self.car_x_coordinate = (self.display_width * 0.3)
            ...
            for event in pygame.event.get():
                ...
                if (event.type == pygame.KEYDOWN):
                    if (event.key == pygame.K_UP):
                        self.car_y_coordinate -= 50
                        print("CAR Y COORDINATES: %s" % self.car_y_coordinate)
